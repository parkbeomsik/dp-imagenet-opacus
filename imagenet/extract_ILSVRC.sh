...
# make sure ILSVRC2012_img_train.tar & ILSVRC2012_img_val.tar in imagenet-data directory
#
#  Adapted from:
...
mkdir -p imagenet-data/train && mv imagenet-data/ILSVRC2012_img_train.tar imagenet-data/train/ && cd imagenet-data/train
...
mkdir imagenet-data/val && mv imagenet-data/ILSVRC2012_img_val.tar imagenet-data/val/ && cd imagenet-data/val && tar -xvf ILSVRC2012_img_val.tar && rm -f ILSVRC2012_img_val.tar
