...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.gn0 = norm_layer(num_channels=inplanes, num_groups=32)
        self.conv1 = conv3x3(inplanes, planes, stride)
        self.gn1 = norm_layer(num_channels=planes, num_groups=32)
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.downsample = downsample
        self.gn0 = norm_layer(num_channels=width, num_groups=32)
        self.conv1 = conv1x1(inplanes, width)
        self.gn1 = norm_layer(num_channels=width, num_groups=32)
        self.conv2 = conv3x3(width, width, stride, groups, dilation)
        self.gn2 = norm_layer(num_channels=width, num_groups=32)
        self.conv3 = conv1x1(width, planes * self.expansion)
        self.gn3 = norm_layer(num_channels=planes * self.expansion, num_groups=32)
        self.relu = nn.ReLU(inplace=True)
        self.stride = stride
...
class ResNet(nn.Module):
    def __init__(
        ...
        self.gn = norm_layer(num_channels=self.inplanes, num_groups=32)
        self.relu = nn.ReLU(inplace=True)
